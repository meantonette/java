...
public class StudentClass {
	//member variables
		...
		public StudentClass(String studName, String studYear,String studCourse,String studSubj) {
		...
		public StudentClass (int quiz1,int quiz2,int quiz3,int unit1,int unit2,int term) { 
		this.quiz1 = quiz1;
		 this.quiz2 = quiz2;
		 this.quiz3 = quiz3;
		 this.unit1 = unit1;
