...
public class BSITsubclass extends Student {
	private String TeachName;
	private String TeachDept;
	
	public BSITsubclass(String lname, String fname, int age, String addr, String telnum, String Tname, String Tdept) {
	...
	public BSITsubclass(String scode,String ycode,String ccode) {
		super(scode, ycode, ccode);
		}
	
	public BSITsubclass(int quiz1,int quiz2,int quiz3,int unit1,int unit2,int term)
	{
